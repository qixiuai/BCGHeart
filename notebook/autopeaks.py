...
class AutoPeaks(object):
    ...
    def __init__(self, thres=0.65, min_dist=80, fs=200):
...
def main(argv):
    ...
    filepath = "/home/guo/BCGHeart/data/ZouYouhong.txt"
    signal = load_bcg(filepath)
    signal = signal[10000:20000]
    signal = np.asarray(signal)
    autopeaks = AutoPeaks(thres=0.75, min_dist=400, fs=1000)
