...
toolchain {
  ...
  tool_path { name: "ar" path: "%{ARM_COMPILER_PATH}%/bin/arm-none-eabi-ar" }
  tool_path { name: "compat-ld" path: "/bin/false" }
  tool_path { name: "cpp" path: "%{ARM_COMPILER_PATH}%/bin/arm-none-eabi-cpp" }
  tool_path { name: "dwp" path: "%{ARM_COMPILER_PATH}%/bin/arm-none-eabi-dwp" }
  tool_path { name: "gcc" path: "%{ARM_COMPILER_PATH}%/bin/arm-none-eabi-gcc" }
  tool_path { name: "gcov" path: "%{ARM_COMPILER_PATH}%/bin/arm-none-eabi-gcov" }
  tool_path { name: "ld" path: "%{ARM_COMPILER_PATH}%/bin/arm-none-eabi-ld" }

  tool_path { name: "nm" path: "%{ARM_COMPILER_PATH}%/bin/arm-none-eabi-nm" }
  tool_path { name: "objcopy" path: "%{ARM_COMPILER_PATH}%/bin/arm-none-eabi-objcopy" }
  tool_path { name: "objdump" path: "%{ARM_COMPILER_PATH}%/bin/arm-none-eabi-objdump" }
  tool_path { name: "strip" path: "%{ARM_COMPILER_PATH}%/bin/arm-none-eabi-strip" }

  cxx_builtin_include_directory: "%{ARM_COMPILER_PATH}%/arm-none-eabi/include/c++/4.9.3/"
  cxx_builtin_include_directory: "%{ARM_COMPILER_PATH}%/arm-none-eabi/sysroot/usr/include/"
  cxx_builtin_include_directory: "%{ARM_COMPILER_PATH}%/arm-none-eabi/libc/usr/include/"
  cxx_builtin_include_directory: "%{ARM_COMPILER_PATH}%/lib/gcc/arm-none-eabi/4.9.3/include"
  cxx_builtin_include_directory: "%{ARM_COMPILER_PATH}%/lib/gcc/arm-none-eabi/4.9.3/include-fixed"
  ...
  cxx_flag: "-isystem"
  cxx_flag: "/usr/include/arm-none-eabi"
  cxx_flag: "-isystem"
